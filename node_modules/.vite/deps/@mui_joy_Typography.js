...
function createBox(options = {}) {
  ...
  const Box2 = React3.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime2.jsx)(BoxRoot, _extends2({
      as: component,
      ref,
...
function processStyleArg(callableStyle, _ref) {
  let {
    ownerState
  } = _ref, props = _objectWithoutPropertiesLoose2(_ref, _excluded5);
  ...
  if (!!resolvedStylesArg && typeof resolvedStylesArg === "object" && Array.isArray(resolvedStylesArg.variants)) {
    const {
      variants = []
    } = resolvedStylesArg, otherStyles = _objectWithoutPropertiesLoose2(resolvedStylesArg, _excluded22);
...
function createStyled(input = {}) {
  ...
  return (tag, inputOptions = {}) => {
    ...
    } = inputOptions, options = _objectWithoutPropertiesLoose2(inputOptions, _excluded32);
...
function RtlProvider(_ref) {
  ...
  return (0, import_jsx_runtime3.jsx)(RtlContext.Provider, _extends2({
...
function prepareCssVars(theme, parserConfig) {
  ...
  } = theme, otherTheme = _objectWithoutPropertiesLoose2(theme, _excluded7);
  const {
    vars: rootVars,
    css: rootCss,
  ...
  const {
    [defaultColorScheme]: light
  } = colorSchemes, otherColorSchemes = _objectWithoutPropertiesLoose2(colorSchemes, [defaultColorScheme].map(toPropertyKey));
...
function createContainer(options = {}) {
  ...
  const Container2 = React10.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime8.jsx)(ContainerRoot, _extends2({
        as: component,
        ownerState,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React11.forwardRef(function Grid3(inProps, ref) {
    ...
    } = props, rest = _objectWithoutPropertiesLoose2(props, _excluded9);
    ...
    let result = (0, import_jsx_runtime9.jsx)(GridRoot, _extends2({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
function createStack(options = {}) {
  ...
  const Stack2 = React12.forwardRef(function Grid2(inProps, ref) {
    ...
    return (0, import_jsx_runtime10.jsx)(StackRoot, _extends2({
      as: component,
      ownerState,
      ref,
      className: clsx_default(classes.root, className)
...
init_utils();
var _excluded12 = ["className", "elementType", "ownerState", "externalForwardedProps", "getSlotOwnerState", "internalForwardedProps"];
...
function useSlot(name, parameters) {
  ...
  } = parameters, useSlotPropsParams = _objectWithoutPropertiesLoose(parameters, _excluded12);
  const {
...
var _excluded13 = ["color", "textColor"];
...
var TypographyNestedContext = React13.createContext(false);
if (true) {
  TypographyNestedContext.displayName = "TypographyNestedContext";
}
var TypographyInheritContext = React13.createContext(false);
if (true) {
...
var Typography = React13.forwardRef(function Typography2(inProps, ref) {
  ...
  const _useThemeProps = useThemeProps2({
    ...
    color: colorProp,
    textColor
  } = _useThemeProps, themeProps = _objectWithoutPropertiesLoose(_useThemeProps, _excluded13);
  const nesting = React13.useContext(TypographyNestedContext);
  const inheriting = React13.useContext(TypographyInheritContext);
  ...
  return (0, import_jsx_runtime11.jsx)(TypographyNestedContext.Provider, {
    value: true,
    children: (0, import_jsx_runtime12.jsxs)(SlotRoot, _extends({}, rootProps, {
      ...
      })), hasSkeleton ? React13.cloneElement(children, {
