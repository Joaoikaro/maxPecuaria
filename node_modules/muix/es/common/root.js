...
import { View, Typography } from 'muix-primitives';
...
class AppRoot extends React.Component {
    constructor() {
        super(...arguments);
        this.state = { appIndex: 0, rtl: false, light: false };
    }
    render() {
...
class AppItem extends React.PureComponent {
    render() {
        ...
        return <Button color='primary' disabled={active} onClick={() => appRoot.setState(state => (Object.assign({}, state, { appIndex: idx })))}>{apps[idx].title}</Button>;
    }
}
